      ...
      <div className="md:flex-1 flex flex-col md:justify-center gap-5 md:gap-10">
        <div className="flex items-center gap-2">
          <span className="relative font-bold text-green-200 dark:text-green-100 text-2xl sm:text-3xl md:text-4xl">
            <span
              className="absolute bottom-[-5px] left-0 w-full bg-green-500 bg-opacity-[0.6]"
              style={{ height: "30%" }}
            />
            <TypeAnimation
        ...
        <p className="text-base text-white">
          I&apos;m from Indonesia and I&apos;ve been working as a freelancer for
          1 year. Right now, I&apos;m looking forward to collaborating with you!
        </p>

        <div className="flex gap-[10px] flex-wrap">
          <SosialBtn desc="discord" Icon={FaDiscord} className="bg-blue-500" />
          <SosialBtn desc="github" Icon={FaGithub} className="bg-black" />
          <SosialBtn
            desc="instagram"
            Icon={FaInstagram}
